...
## Project Structure
    ...
    ├── testingappcreation__45156  # Django project configurations
...
1. Clone this repo and `cd testingappcreation__45156`
...
2. Clone this repo and `cd testingappcreation__45156`
